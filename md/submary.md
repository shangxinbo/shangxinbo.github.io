...
技术栈里在方舟项目中使用handlerbars,artTemplate,swig三种模板引擎技术，重新考虑PC端浏览器兼容问题，初探vue及其生态，使用vue生态尝试重构方舟项目，熟悉使用gulp编译工具，使用webpack1.x整合vue项目，尝试基础的es6语法。node平台开始熟悉并在生产环境用于自动化脚本的工具。讨厌说全栈的人，自诩是Jser.

前几年经营的Cordova群在今年开始尝试收费。给弟弟做了一套快递管理平台，对接短信发送平台.
